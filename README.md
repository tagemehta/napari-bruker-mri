...
| Compare irradiated vs. control trends across timepoints (ANOVA + FDR-corrected contrasts) | `compare_trends.py` |
...
5. `compare_trends.py` — re-run once new discs are added, to refresh the trend and ANOVA/contrast tables across the whole cohort.
